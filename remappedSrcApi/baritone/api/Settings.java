...
public final class Settings {
     ...
     */
    public final Setting<TagKey<Item>> acceptableThrowawayItems = new Setting<>(TagKey.create(
            Registries.ITEM,
            new ResourceLocation("automatone", "throwaway_blocks")
    ));

    /**
     * Blocks that Baritone will attempt to avoid (Used in avoidance)
     */
    public final Setting<TagKey<Block>> blocksToAvoid = new Setting<>(TagKey.create(Registries.BLOCK,
            new ResourceLocation("automatone", "avoided_blocks")
    ));

    /**
     * Blocks that Baritone is not allowed to break
     */
    public final Setting<TagKey<Block>> blocksToAvoidBreaking = new Setting<>(TagKey.create(Registries.BLOCK,
            new ResourceLocation("automatone", "no_break")
    ));
     ...
     */
    public final Setting<TagKey<Block>> buildIgnoreBlocks = new Setting<>(TagKey.create(Registries.BLOCK,
            new ResourceLocation("automatone", "build/ignored_blocks")
    ));
     ...
     */
    public final Setting<TagKey<Block>> okIfAir = new Setting<>(TagKey.create(Registries.BLOCK,
        new ResourceLocation("automatone", "build/ok_if_air")
    ));
     ...
     * {@link Setting#get()};
     */
    public final Setting<Consumer<Component>> logger = new Setting<>(message -> Minecraft.getInstance().gui.getChat().addMessage(message));
