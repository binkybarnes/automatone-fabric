...
public class MovementDiagonal extends Movement {
    ...
    private static BetterBlockPos[] computeBlocksToBreak(LivingEntity entity, BetterBlockPos end, BetterBlockPos dir1, BetterBlockPos dir2) {
        if (entity.getDimensions(Pose.STANDING).height <= 1) {
    ...
    public static void cost(CalculationContext context, int x, int y, int z, int destX, int destZ, MutableMoveResult res) {
        ...
        double multiplier = WALK_ONE_BLOCK_COST / destWalkOn.getBlock().getSpeedFactor() / 2;
        ...
        multiplier += WALK_ONE_BLOCK_COST / fromDown.getSpeedFactor() / 2;
